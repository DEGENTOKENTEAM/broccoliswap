...
const DGNXPrice = () => {
    ...
    const updatePrice = async () => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_BACKEND_ENDPOINT!}/ohlc/avalanche/0x51e48670098173025c477d9aa3f0eff7bf9f7812/${currentTime}/${currentTime}/1D/1`)
            .then(x => x.json())
            .then((data) => {
    ...
    return (
        <>
            ...
            >
                <Image src="/logo.png" alt="Swap image" unoptimized width="18" height="18" />
            </div>
            <span className="text-xs">DGNX {price ? formatter.format(price) : '...'}</span>
        </>
    )
}
                    ...
                    <div className="mx-auto pl-2 sm:pl-3 lg:pl-3">
                        <div className="relative flex h-10 items-center justify-between">
                            <div className="flex flex-1 h-full stems-center justify-start">
                                ...
                                <div className="flex text-slate-200 items-center border-x border-zinc-800 px-2 h-full text-xs">
                                    Powered by
                                    <a href="https://coingecko.com/" target="_blank" rel="noreferrer">
                                        <Image src="/cg.png" alt="Coingecko" unoptimized width="20" height="20" className="ml-2" />
                                    </a>
                                    <a href="https://bitquery.io/" target="_blank" rel="noreferrer">
                                        <Image src="/bitquery.png" alt="Bitquery" unoptimized width="20" height="20" className="ml-1" />
                                    </a>
                                    <a href="https://rubic.exchange/" target="_blank" rel="noreferrer">
                                        <Image src="/rubic.png" alt="Rubic Exchange" unoptimized width="20" height="20" className="ml-1" />
                                    </a>
                                </div>
